...
**Plans**: 4/6 plans executed (6 waves — strictly sequential; waves 3-6 are calendar-gated on the validation gameweek)
...
- [x] 07-04-PLAN.md — Validation pass 2: mid-gameweek comparison while matches are live or settling, and defect closure
...
| 7. Parity Validation & Cutover | 4/6 | In Progress|  |
...
**Requirements**: TBD
**Depends on:** Phase 7
**Plans:** 4/5 plans executed (5 waves) — Wave 5 halted: defer decision recorded pending Phase 7 CUT-01 (see 08-05-SUMMARY.md)
...
- [x] 08-02-PLAN.md — Mutable current-season file refreshes, payload field guards, snapshot-backed xP resolution, per-gameweek ledger, rate-limited sweep, freshness alert

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 08-03-PLAN.md — The real backfill: capture every finished gameweek live, cross-check gameweek 1 against vaastav's published copy, rebuild the canonical table

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 08-04-PLAN.md — data/ingest.py current-season guard (vaastav demoted in code) plus the operator runbook

**Wave 5** *(blocked on Wave 4 completion — gated on Phase 7 CUT-01 lifting the cron-script freeze)*

- [ ] 08-05-PLAN.md — The single frozen-file edit: the daily cron capture step and its ordering regression test (halted: developer answered `defer` — Phase 7 freeze still holds; see 08-05-SUMMARY.md)
